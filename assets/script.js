...
function displayWeather(data) {
  ...
  $('#day2date').text(data.list[8].dt_txt)
  $('#day2icon').attr('src', 'http://openweathermap.org/img/w/' + data.list[16].weather[0].icon + '.png')
  $('#day2temp').text(data.list[8].main.temp + ' F')
  $('#day2wind').text(data.list[8].wind.speed + 'mph')
  $('#day2humid').text(data.list[8].main.humidity + '% Humidity')
